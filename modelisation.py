...
contour_data = [[[1, 2, 3, 4], [(n - 1, 0, 0), (0, 1, 0), (0, 0, 1), (n - 1, 1, 1)]],
...
# Now we can define the rotation function that takes in the face index, the angle and the state and returns the new state
# but first we will define a function that take in the face and the angle and returns the center and contour indexes.
